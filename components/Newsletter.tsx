  ...
  return (
    ...
    <div className="mx-auto grid justify-items-center max-w-screen-2xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
      <div className="max-w-xl text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:col-span-7">
        <h2 className="inline sm:block lg:inline xl:block max-sm:text-xl">Quer novidades e atualizações de produtos?</h2>{' '}
        <p className="inline sm:block lg:inline xl:block max-sm:text-xl">Inscreva-se na nossa newsletter.</p>
      </div>
      <form className="w-full max-w-md lg:col-span-5 lg:pt-2">
        ...
        <p className="mt-4 text-sm leading-6 text-gray-900">
          Nós nos importamos com seus dados. Leia nossa{' '}
