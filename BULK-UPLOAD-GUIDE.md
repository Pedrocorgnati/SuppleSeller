...
| ---------------- | -------- | ------ | ------------------------------------------------------ | --------------------------------- |
| **title**        | ✅ Ya    | String | Nama produk                                            | Whey Protein Isolado              |
| **price**        | ✅ Ya    | Number | Harga produk (gunakan titik untuk desimal)             | 129.99                            |
| **manufacturer** | ✅ Ya    | String | Nama manufaktur/brand                                  | SuppleSeller                      |
| **inStock**      | ❌ Tidak | Number | Jumlah stok (default: 0)                               | 80                                |
| **mainImage**    | ❌ Tidak | URL    | URL gambar produk                                      | https://example.com/image.jpg     |
| **description**  | ✅ Ya    | String | Deskripsi produk                                       | Whey isolado com 26g de proteína. |
| **slug**         | ✅ Ya    | String | URL-friendly identifier (gunakan huruf kecil dan dash) | whey-protein-isolado              |
| **categoryId**   | ✅ Ya    | String | ID kategori dari database (atau nama kategori)         | whey                              |
...
- **Slug**: Harus URL-friendly (lowercase, no spaces)
  ...
  - ✅ Benar: `whey-protein-isolado`
  - ❌ Salah: `Whey Protein Isolado`

- **Text dengan Koma**: Gunakan tanda kutip ganda
  - ✅ Benar: `"Blend com BCAA, glutamina e eletrólitos para recuperação."`
  - ❌ Salah: `Blend com BCAA, glutamina e eletrólitos para recuperação.`
...
```csv
title,price,manufacturer,inStock,mainImage,description,slug,categoryId
Whey Protein Isolado,129.99,FitFuel,80,https://example.com/whey.jpg,Whey isolado com 26g de proteína e baixo carbo,whey-protein-isolado,whey
```
...
```csv
title,price,manufacturer,inStock,mainImage,description,slug,categoryId
"Creatina Monohidratada","79.99",PureLift,150,https://example.com/creatina.jpg,"Creatina 100% monohidratada para força, potência e volume muscular.",creatina-monohidratada,creatina
```
